...
(() => {
  ...
  const o = () => {
    return e = void 0, r = null, o = function* () {
      return new Promise(((e, r) => {
        const o = `${Date.now()}-${Math.random()}`, t = setTimeout((() => {
  ...
  var t = Object.defineProperty, a = Object.getOwnPropertySymbols, n = Object.prototype.hasOwnProperty,
    s = Object.prototype.propertyIsEnumerable,
    i = (e, r, o) => r in e ? t(e, r, {enumerable: !0, configurable: !0, writable: !0, value: o}) : e[r] = o,
    d = (e, r) => {
  ...
  if (window === window.top || window.sdkLoaderWasInited) {
    ...
    const c = {type: "unknown", isMobile: () => !1, isTablet: () => !1, isDesktop: () => !1, isTV: () => !1},
      l = (e, r = {}) => {
        var o, t;
        window.parent.postMessage({
          ...
          data: {
            ...
            additional: d(d(d({}, r), (null == (o = r.error) ? void 0 : o.message) ? {originalMessage: null == (t = r.error) ? void 0 : t.message} : {}), r.source ? {originalSource: r.source} : {}),
            level: "error",
            source: "sdk-loader",
            type: "error"
          }
    ...
    Object.defineProperty(window.YaGames, "deviceInfo", {get: () => (l("accessing deviceInfo in YaGames"), c)});
    const u = e => {
        const r = document.querySelectorAll(`script[src="${e}"]`);
        for (let e of Array.from(r)) e.remove()
      }, m = /^(https|yandexgames):\/\/[^\/][^.][\w.\/\-]+\/sdk\/v2(\?|$)/,
      w = /(^|yandex\.net)\/sdk\/(v\d+|_)\/v2(\.[0-9a-f]*)?\.js/, f = "url sdk not valid", v = "load sdk file error",
      p = 3, g = (o, a) => {
        ...
        d.src = o, d.onload = () => {
          ...
          u(o), a > 0 ? g(o, --a) : (i = !0, l(v, {event: e, error: c, source: t}), n && r(v))
    ...
    y ? h(y) : o().then((e => {
      const r = new URL(e), o = r.searchParams, t = o.get("sdk"), a = o.get("dvh") || "";
      if (t) h(t, a); else {
        const e = new URLSearchParams(r.search).get("sdk");
        h(e)
      }
    })).catch((e => {
      l("Error while get iframe src", {error: e}), console.error("SDK initialization failed", e)
    }))
  }
  YaGamesLoader = r
})();
